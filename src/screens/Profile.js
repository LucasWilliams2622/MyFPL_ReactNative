...
const Profile = () => {
  return (
    <SafeAreaView style={[AppStyle.container]}>
      <View style={[AppStyle.column, AppStyle.boxShadow, { paddingHorizontal: 12, paddingVertical: 8, borderBottomStartRadius: 20, borderBottomEndRadius: 20, width: '100%' ,elevation:1}]}>
